    ...
    for (const empPayrollData of empPayrollList){
        innerHtml =`${innerHtml}
            <tr>
                ...
                <td>
                    <img name="${empPayrollData._id}" onclick="remove(this)" src="C:\Users\sachi\Downloads\FS HTML_CSS LP02 Employee Payroll App Assets\assets\icons\delete-black-18dp.svg" alt="delete">
                    <img name="${empPayrollData._id}" onclick="update(this)" src="C:\Users\sachi\Downloads\FS HTML_CSS LP02 Employee Payroll App Assets\assets\icons\create-black-18dp.svg" alt="edit">
                </td>
            </tr>
        `;
    }    
